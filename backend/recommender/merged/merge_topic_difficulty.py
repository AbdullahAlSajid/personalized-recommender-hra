...
Inputs:
    results.csv                   — from topic_pipeline.py
    final_difficulty_scores.csv   — from pairwise_pipeline.py

Outputs:
    results_with_difficulty.csv   — merged final dataset
"""
...
# ── Select difficulty columns to merge ───────────────────────────────────────
...
print(f"  Key columns:")
print(f"    final_difficulty  — use this for recommendation matching")
print(f"    difficulty_rank   — use this for ranking within results")
print(f"    reliable          — filter on True for high-confidence scores")
print(f"    broad_topics      — use this for topic-based filtering")
print(f"    text_type         — fagtekst or fortelling")