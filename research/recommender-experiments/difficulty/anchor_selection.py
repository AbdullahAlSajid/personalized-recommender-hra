...
NOR_STOPWORDS = {
    "og", "i", "p+Ñ", "av", "for", "med", "til", "er", "som", "det", "de", "en",
    "et", "ei", "+Ñ", "at", "om", "den", "det", "har", "hadde", "var", "ble",
    "blir", "ikke", "s+Ñ", "fra", "kan", "skal", "vil", "vi", "du", "han", "hun",
    "man", "seg", "sin", "sitt", "sine", "men", "eller", "ogs+Ñ", "der", "her",
    "da", "n+Ñr", "etter", "f++r", "over", "under", "ut", "inn"
}

# Some cue words that may hint at subordination / syntactic complexity
SUBORDINATION_CUES = {
    "fordi", "dersom", "hvis", "selv om", "som", "mens", "da", "n+Ñr", "etter at",
    "f++r", "siden", "selvf++lgelig", "selv om", "slik at"
}
