...
Dimension definitions:
  vocab_difficulty         GÇö complexity and rarity of vocabulary; domain-specific or uncommon words
  sentence_complexity      GÇö sentence length, subordinate clauses, syntactic depth
  abstractness             GÇö how abstract vs concrete the ideas are
  background_knowledge     GÇö prior knowledge a child needs to understand the text
  cohesion_structure       GÇö how clearly the text guides the reader; logical flow and transitions
