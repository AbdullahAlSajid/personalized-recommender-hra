...
Generates anchor candidates using a hybrid score combining:
  - LIX (70%) GÇö validated for Norwegian by Bj+¦rnsson (1968) and Wold et al. (2024)
  - Supplementary NLP features (30%) GÇö addressing LIX's known limitations
...
Key design decisions:
  ...
  - Band assignment uses pd.qcut (corpus-relative equal bands) because all texts
    ...
    LIX range (-¦=21.57, Wold et al. 2024) GÇö absolute thresholds designed for
...
References:
  Bj+¦rnsson, C-H. (1968). L+ñsbarhetsindex. Bokf+¦rlaget Liber.
  Wold, S., M+ªhlum, P., & Hove, O. (2024). Estimating Lexical Complexity
...
Inputs:
    question_texts_texts.csv   GÇö raw corpus CSV

Outputs:
    all_texts_lix_scores_v2.csv         GÇö LIX + hybrid scores for all 157 texts
    anchor_candidates_shortlist_v2.csv  GÇö 15 candidates (3 per band) for LLM evaluation
"""
...
NOR_STOPWORDS = {
    "og", "i", "p+Ñ", "av", "for", "med", "til", "er", "som", "det", "de",
    "en", "et", "ei", "+Ñ", "at", "om", "den", "har", "hadde", "var", "ble",
    "blir", "ikke", "s+Ñ", "fra", "kan", "skal", "vil", "vi", "du", "han",
    "hun", "man", "seg", "sin", "sitt", "sine", "men", "eller", "ogs+Ñ",
    "der", "her", "da", "n+Ñr", "etter", "f++r", "over", "under", "ut", "inn",
}

# Subordination cue words (proxy for syntactic complexity)
# Vajjala & Meurers (2012): subordinate clauses as readability predictor
SUBORDINATION_CUES = {
    "fordi", "dersom", "hvis", "selv om", "mens", "da", "n+Ñr",
...
def clean_markdown(text):
    if pd.isna(text):
        return ""
    text = str(text)
    text = text.replace("+â-+", "++").replace("+â-£", "+ÿ")
    text = text.replace("+â-Ñ", "+Ñ").replace("+âGÇª", "+à")
    text = text.replace("+â-ª", "+ª").replace("+âGÇá", "+å")
...
def tokenize(text):
    return re.findall(r"\b[a-zA-Z+ª+++Ñ+å+ÿ+à]+\b", text.lower())
...
# GöÇGöÇ Load data GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
# GöÇGöÇ Build corpus-wide doc frequency for rare word ratio GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
# GöÇGöÇ Compute features GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
for i, (_, row) in enumerate(df.iterrows()):
    ...
    # GöÇGöÇ LIX components GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    # Bj+¦rnsson (1968): LIX = (words/sentences) + (long_words+ù100/words)
    ...
    # GöÇGöÇ Supplementary features GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    # These cover dimensions LIX does not capture.
    ...
    # Rare word ratio: words appearing in Gëñ2 corpus documents
    ...
    # GöÇGöÇ Structural metadata GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    paragraph_count = len([
...
# GöÇGöÇ Hybrid score GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
# Step 4: hybrid score
# 70% LIX (Bj+¦rnsson 1968, Wold et al. 2024) +
...
# children's literature LIX range (-¦=21.57, Wold et al. 2024).
# Absolute thresholds designed for the full Norwegian text spectrum
# (children GåÆ parliament) are not applicable within this corpus.
...
# GöÇGöÇ Print corpus LIX summary (reference to Wold et al. 2024) GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ

print(f"\n{'GöÇ'*55}")
print(f"  CORPUS LIX SUMMARY")
print(f"  (Wold et al. 2024: Norwegian children's books -¦=21.57)")
print(f"{'GöÇ'*55}")
...
# GöÇGöÇ Select candidates GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
for band in [f"Band_{i}" for i in range(1, N_BANDS + 1)]:
    ...
    for rank, (_, r) in enumerate(candidates.iterrows(), 1):
        ...
        shortlist_rows.append({
            ...
            "title":                        r["title"],
            # LIX score (primary component, Bj+¦rnsson 1968)
            "lix":                          round(r["lix"], 4),
            # Hybrid score
...
print(f"\n  Saved GåÆ {all_scores_path}")
print(f"  Saved GåÆ {shortlist_path}")
print(f"\n  Next step:")
print(f"  Run anchor_selector.py with --shortlist {shortlist_path}")

# GöÇGöÇ Uncomment after manual/LLM review to finalize anchors GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
"""
...
if not bad.empty:
    ...
    print(f"Saved final anchors GåÆ {out}")
"""
