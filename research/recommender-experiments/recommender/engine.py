...
============================================================
Master's Thesis G«ˆ University of Stavanger
Target: Children aged 9G«Ù11
Corpus: 157 texts with topic labels and difficulty scores (1.0G«Ù5.0)

Architecture
------------
Session-based content recommender with two scoring components:
  1. Topic match  G«ˆ recall overlap between student interests and text broad_topics
  2. Difficulty match G«ˆ Gaussian kernel targeting the student's growth zone
...
# GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…
# Constants
# GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…GÚ…
...
WEIGHT_SCHEDULE: Dict[int, Tuple[float, float]] = {
    1: (1.00, 0.00),   # cold start G«ˆ topic only
    2: (0.70, 0.30),   # one difficulty rating G«ˆ topic dominant
    3: (0.50, 0.50),   # two+ ratings G«ˆ balanced
}
...
class LevelEstimator:
    ...
    Scaling factor 0.5 maps the full perceived range (1G«Ù5) to -¶1.0.

    Session estimate = simple mean of all implied levels.
    No exponential weighting G«ˆ with 5G«Ù7 observations, every data point matters.
    ...
    def update(self, text_difficulty: float, perceived_difficulty: int) -> float:
        ...
        Parameters
        ----------
        text_difficulty     : The text's final_difficulty (1.0G«Ù5.0)
        perceived_difficulty: Student's rating of "how hard did you find it?" (1G«Ù5)

        Returns
        -------
        The implied level computed from this observation (clipped to 1.0G«Ù5.0).
        Access estimated_level property for the session mean across all observations.
        """
        if not (1 <= perceived_difficulty <= 5):
            raise ValueError(f"perceived_difficulty must be 1G«Ù5, got {perceived_difficulty}")
...
class ScoringEngine:
    ...
    Two components:
        topic_score     = |student_interests GÍ¨ text_broad_topics| / |student_interests|
        difficulty_score = Gaussian(text_diff; ++=estimated_level+0.2, -‚=0.8)
...
class ReadingEvent:
    ...
    perceived_difficulty: int        # 1G«Ù5
    interest_rating: int             # 1G«Ù5 (evaluation only)
    comprehension_score: float       # 0.0G«Ù1.0 (evaluation only)
    round_number: int
...
class SessionManager:
    ...
    # Gˆ«Gˆ« Candidate filtering Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«
    ...
    # Gˆ«Gˆ« Slate generation Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«
    ...
    # Gˆ«Gˆ« Refresh Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«

    def handle_refresh(self, shown_text_ids: List[str]) -> pd.DataFrame:
        """
        Mark shown texts as seen, log the refresh, return new slate.
        No profile update G«ˆ refresh signal is ambiguous.
        """
    ...
    # Gˆ«Gˆ« Record reading Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«
    ...
    def record_reading(
        ...
        perceived_difficulty : "How hard did you find it?" (1G«Ù5) GÂ∆ used for adaptation
        interest_rating      : "How interesting was it?" (1G«Ù5) GÂ∆ evaluation only
        comprehension_score  : MCQ/TF proportion correct (0.0G«Ù1.0) GÂ∆ evaluation only
        """
        if not (1 <= perceived_difficulty <= 5):
            raise ValueError(f"perceived_difficulty must be 1G«Ù5, got {perceived_difficulty}")
        if not (1 <= interest_rating <= 5):
            raise ValueError(f"interest_rating must be 1G«Ù5, got {interest_rating}")
        if not (0.0 <= comprehension_score <= 1.0):
            raise ValueError(f"comprehension_score must be 0.0G«Ù1.0, got {comprehension_score}")
    ...
    # Gˆ«Gˆ« Explanation (Norwegian) Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«
    ...
    def explain(self, text_row: dict) -> str:
        ...
        if level is not None:
            ...
            if abs(diff_gap) < 0.4:
                ...
                lines.append(f"    Litt mer utfordrende G«ˆ bra for +— strekke seg!")
            else:
                lines.append(f"    Litt lettere G«ˆ god for flytsone-lesing")

        return "\n".join(lines)

    # Gˆ«Gˆ« Session summary Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«Gˆ«
