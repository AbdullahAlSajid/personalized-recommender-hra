...
EVALUATED_CSV   = "anchor_candidates_evaluated_v2.csv"
FINAL_CSV       = "final_anchors_v2.csv"
...
Dimension definitions:
  ...
  *** The following three dimensions are particularly important as they
  ...
  vocab_difficulty         — complexity and rarity of vocabulary; presence of
                             domain-specific, technical, or uncommon words that
                             a child would not encounter in everyday language
  background_knowledge     — how much prior knowledge a child needs to understand
                             the text; domain expertise required; assumed
                             familiarity with concepts, events, or fields
  abstractness             — how abstract vs concrete the ideas are; whether
  ...
  cohesion_structure       — how clearly the text guides the reader; logical flow
...
Anchor suitability (overall_anchor_suitability_1to5):
  ...
  Penalize heavily: texts under 100 words — these are fragments, not
...
Rules:
  ...
  - Weight vocab_difficulty, background_knowledge, and abstractness heavily —
  ...
  - A text about a familiar everyday topic with simple vocabulary is easier
    than a text about a technical or unfamiliar topic even if sentence lengths
    are similar.
